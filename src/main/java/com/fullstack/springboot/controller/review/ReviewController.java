...
public class ReviewController {
	...
	public ReviewDTO getReviewOne(@PathVariable("rno") Long rno) {
		return reviewService.getReviewOne(rno);
	}
	
	@GetMapping("/cnt/{pno}")
	public int getReviewCnt(@PathVariable("pno") Long pno) {
		return reviewService.getReviewCnt(pno);
	}
	
	@PostMapping("/add/{orno}")
	public void addReview(@PathVariable("orno") Long orno, @RequestBody ReviewDTO reviewDTO) {
		reviewService.register(orno, reviewDTO);
	}
