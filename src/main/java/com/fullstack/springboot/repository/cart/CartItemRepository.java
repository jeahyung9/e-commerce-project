...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
	...
	@Query("select " +
			"new com.fullstack.springboot.dto.cart.CartItemDTO(ci.cino, od.odno, p.pno, s.sno, c.cno, c.member.mno, p.p_name, od.od_name, od.od_price, od.od_salesVol, p.p_price, p.p_salePer, s.businessName, ci.c_cnt, p.p_stock, od.od_stock, pi.pi_name, pi.pi_path) from " +
	...
	@Query("select " +
			...
			"order by pno, odno, ci desc")
	public CartItemDTO getCartItemOne(@Param("mno") Long mno, @Param("odno") Long odno);
